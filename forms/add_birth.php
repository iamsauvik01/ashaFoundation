...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO record_of_birth (mother_name, date, time, place_of_birth, sender) VALUES ('$mother_name', '$date', '$time', '$place', '$sender')";
...
<head>
    ...
    <title>Record of Birth Form</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>

<h2>Record of Birth Form</h2>

<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    <label for="mother_name">Name of Mother:</label><br>
    ...
    <button class="go-back-button">
        <a href="../tables/record_birth.php">
            Go Back
        </a>
    </button>
</form>
